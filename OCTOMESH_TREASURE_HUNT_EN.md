...
The default values (`-tenant meshtest`, `-baseUrl https://localhost:5020`) work for the local demo. In any other environment specify `-tenant` and `-baseUrl` explicitly.
